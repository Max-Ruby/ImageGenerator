...
def digit_generator(total_digit_dimension, num_digits):
    ...
    coarse_1 = BatchNormalization()(Conv2D(32, (3, 3), padding='same',kernel_initializer='he_normal', activation='elu')(coarse_1))
    ...
    mid_2 = BatchNormalization()(Conv2D(16, (3, 3), padding='same',kernel_initializer='he_normal', activation='elu')(coarse_2))
    mid_2 = BatchNormalization()(Conv2D(16, (3, 3), padding='same',kernel_initializer='he_normal', activation='elu')(mid_2))
    mid_3 = UpSampling2D(size=(2, 2), interpolation='bilinear')(mid_2)
    fine_3 = BatchNormalization()(Conv2D(8, (3, 3), padding='same',kernel_initializer='he_normal', activation='elu')(mid_3))
    fine_3 = BatchNormalization()(Conv2D(8, (3, 3), padding='same',kernel_initializer='he_normal', activation='elu')(fine_3))
...
def digit_discriminator(num_digits):
    ...
    fine = BatchNormalization()(Conv2D(128,(5,5), padding='same',kernel_initializer='he_normal', activation='elu')(image))
    fine = BatchNormalization()(Conv2D(128,(3,3), padding='same',kernel_initializer='he_normal', activation='elu')(fine))
    mid = BatchNormalization()(Conv2D(64,(5,5), padding='same',kernel_initializer='he_normal', activation='elu', strides=(2,2))(fine))
    mid = BatchNormalization()(Conv2D(64,(3,3), padding='same',kernel_initializer='he_normal', activation='elu')(mid))
    coarse = BatchNormalization()(Conv2D(32,(5,5), padding='same',kernel_initializer='he_normal', activation='elu', strides=(2,2))(mid))
    coarse = BatchNormalization()(Conv2D(32, (3, 3), padding='same',kernel_initializer='he_normal', activation='elu')(coarse))
    ...
    composition = Reshape((128+64+32,))(composition)
    composition = Dense(64+32+16, activation='elu',)(composition)

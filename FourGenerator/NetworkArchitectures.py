...
def four_generator(digit_dimension):
    ...
    coarse_1 = Conv2D(digit_dimension, (5, 5), padding='same', activation='elu')(coarse_1)
    coarse_1 = Conv2D(16, (3, 3), padding='same', activation='elu')(coarse_1)
    ...
    fine_3 = Conv2D(4, (3, 3), padding='same', activation='elu')(mid_3)
    fine_3 = Conv2D(4, (3, 3), padding='same', activation='elu')(fine_3)
...
def four_discriminator():
    ...
    fine = Conv2D(8,(3,3), padding='same', activation='elu')(inputs)
    fine = Conv2D(8, (3, 3), padding='same', activation='elu')(fine)
    fine = Conv2D(8,(3,3), padding='same', activation='elu')(fine)
    mid = Conv2D(8,(3,3), padding='same', activation='elu', strides=(2,2))(fine)
    mid = Conv2D(8,(3,3), padding='same', activation='elu')(mid)
    mid = Conv2D(8,(3,3), padding='same', activation='elu')(mid)
    ...
    composition = Reshape((24,))(composition)
